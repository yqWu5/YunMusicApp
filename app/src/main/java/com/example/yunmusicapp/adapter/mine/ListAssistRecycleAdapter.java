...
public class ListAssistRecycleAdapter extends RecyclerView.Adapter<ListAssistRecycleAdapter.ListAssistRecycleHolder> {
    ...
    public ListAssistRecycleAdapter(Context context, FragmentManager fm) {
    ...
    @NonNull
    @Override
    public ListAssistRecycleHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.mine_createlist, parent, false);
        return new ListAssistRecycleHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ListAssistRecycleHolder holder, int position) {
    ...
    class ListAssistRecycleHolder extends RecyclerView.ViewHolder{
        ...
        public ListAssistRecycleHolder(@NonNull View itemView) {
            super(itemView);
